         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Our Room</h2>
                     <p class="fs-4 lh-base fw-normal text-dark">Bienvenue dans votre espace personnalisé. Gérez vos activités, consultez les statistiques en temps réel et optimisez vos interactions. </p>
                  </div>
               </div>
            </div>
