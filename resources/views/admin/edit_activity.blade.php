        ...
        <div class="page-content">
            <div class="div_center">
                ...
                <form action="{{route('update_activity', $activity->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group activity-fields" style="display: {{ $activity->type == 'activity' ? 'block' : 'none' }};">
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-input-wrapper">
                            ...
                            <input type="file" name="image" accept="image/jpeg,image/png,image/gif,image/webp,image/bmp">
                            <small class="text-muted d-block mt-2" style="color: #8a8d93;">
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary">Update Activity/Service</button>
                    </div>
                </form>
            </div>
        </div>
